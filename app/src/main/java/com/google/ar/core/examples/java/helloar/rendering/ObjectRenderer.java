...
public class ObjectRenderer {
     ...
     * @param objInputStream  Name of the OBJ file containing the model geometry.
    ...
    public void draw(float[] cameraView, float[] cameraPerspective, float lightIntensity) {
        ...
        ShaderUtil.checkGLError(TAG, "309");

        // Set the object material properties.
        GLES20.glUniform4f(mMaterialParametersUniform, mAmbient, mDiffuse, mSpecular,
            mSpecularPower);
        ShaderUtil.checkGLError(TAG, "314");
        // Attach the object texture.
        GLES20.glActiveTexture(GLES20.GL_TEXTURE0);
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mTextures[0]);
        GLES20.glUniform1i(mTextureUniform, 0);

        ShaderUtil.checkGLError(TAG, "320");
        ...
        ShaderUtil.checkGLError(TAG, "342");
        if (mBlendMode != null) {
        ...
        ShaderUtil.checkGLError(TAG, "361");
